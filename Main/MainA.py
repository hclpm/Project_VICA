...
server = StreamingServer(my_ip_address, 9999)
receiver = AudioReceiver(my_ip_address, 8888)
...
def start_connect():
    ...
    audio_sender = AudioSender(box_ipInput.get(1.0, 'end-1c'), 2222)
...
background_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/Bg.png")
background = canvas.create_image(
    553.0, 266.5,
    image=background_img)

# 서버 오픈 btn 코드
btn_open_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/serverbtn.png")
btn_open = Button(
    VC_GUI,
    image = btn_open_img,
    borderwidth = 0,
...
# 통화 시작 btn 코드
btn_call_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/Callbtn.png")
btn_call = Button(
    VC_GUI,
    image = btn_call_img,
    borderwidth = 0,
...
# 서버 닫기 btn 코드
btn_server_stop_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/Stop.png")
...
# IP 입력칸 코드
label_ipInput_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/inputBox.png")
...
# 주제 입력칸 코드
label_subjectInput_img = PhotoImage(file = "C:/Users/js2-3/Desktop/Github/PrivateFiles/Projects/Communication_Assistant/Main_12/images/inputBox.png")
