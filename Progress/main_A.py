from my_vidstream import StreamingServer, CameraClient
...
def start_camera_stream():
    ...
    server_thread.start()
    camera_client = CameraClient(box_ipInput.get(1.0, 'end-1c'), 2222)
...
# exit button
btn_finishCall = tk.Button(VC_GUI, text="Stop Video Call", width=50, command=stop_videoCall)
